...
//
// _coder_QSF_w_offset_intctrl_U_api.cpp
//
...
emlrtContext emlrtContextGlobal{
    ...
    "QSF_w_offset_intctrl_U",                             // fFunctionName
                                ...
                                const mxArray *plhs[4])
{
  ...
  mq = emlrt_marshallIn(st, emlrtAliasP(prhs[0]), "mq");
  l = emlrt_marshallIn(st, emlrtAliasP(prhs[1]), "l");
  g = emlrt_marshallIn(st, emlrtAliasP(prhs[2]), "g");
  K1 = b_emlrt_marshallIn(st, emlrtAlias(prhs[3]), "K1");
  K2 = b_emlrt_marshallIn(st, emlrtAlias(prhs[4]), "K2");
  K3 = c_emlrt_marshallIn(st, emlrtAlias(prhs[5]), "K3");
  ref_traj = d_emlrt_marshallIn(st, emlrtAlias(prhs[6]), "ref_traj");
  states = e_emlrt_marshallIn(st, emlrtAlias(prhs[7]), "states");
  psi = emlrt_marshallIn(st, emlrtAliasP(prhs[8]), "psi");
  Td_scaler = emlrt_marshallIn(st, emlrtAliasP(prhs[9]), "Td_scaler");
  Int = f_emlrt_marshallIn(st, emlrtAlias(prhs[10]), "Int");
  // Invoke the target function
  QSF_w_offset_intctrl_U(mq, l, g, *K1, *K2, *K3, *ref_traj, *states, psi,
                         Td_scaler, *Int, *Rbd, &Fld_scaler, &phid, &thetad);
...
void QSF_w_offset_intctrl_U_atexit()
{
  ...
  QSF_w_offset_intctrl_U_xil_terminate();
  QSF_w_offset_intctrl_U_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
// End of code generation (_coder_QSF_w_offset_intctrl_U_api.cpp)
