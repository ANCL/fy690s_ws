...
void Inner_loop(real_T rpy_angles[3], real_T Omega[3], real_T Rd[9],
                real_T Omegad[3], real_T dOmegad[3], real_T Fl, real_T gains[2],
                real_T physics_param[6], real_T L_offset[3],
                real_T ddxi_flat[3], real_T load_acc[3], real_T taub[3],
                real_T tau[3], real_T rate_sp[3]);
...
#endif
// End of code generation (_coder_Inner_loop_api.h)
