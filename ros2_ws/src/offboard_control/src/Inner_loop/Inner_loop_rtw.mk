...
COMPILER_COMMAND_FILE     = Inner_loop_rtw_comp.rsp
CMD_FILE                  = Inner_loop_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = Inner_loop.lib
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=Inner_loop
...
Inner_loop_initialize.obj : "$(START_DIR)\codegen\lib\Inner_loop\Inner_loop_initialize.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\codegen\lib\Inner_loop\Inner_loop_initialize.cpp"


Inner_loop_terminate.obj : "$(START_DIR)\codegen\lib\Inner_loop\Inner_loop_terminate.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\codegen\lib\Inner_loop\Inner_loop_terminate.cpp"
